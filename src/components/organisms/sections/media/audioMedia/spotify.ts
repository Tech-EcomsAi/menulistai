...
const SpotifyAudioMediaConfig = (UID) => {
    return {
        id: getUID(),//id used for dnd
        sectionId: CATEGORIES_LIST.MEDIA,
        componentName: "Audio Container",
        ...
        "children": [
            {
                "uid": `${UID}${SECTION_UID_SEPARATOR}${getUID()}`,
                "component": COMPONENTS_TYPE.AUDIO,
                "componentName": "Audio",
                "props": {
                    ...
                    // preload:true,
                    "src": "https://open.spotify.com/embed/track/5ozqshq2dtU7SYCpCBu0NE?utm_source=generator"
                },
                "editable": { label: 'Spotify Audio', style: [BORDER_RADIUS, BOX_SHADOW, SIZE, OBJECT_FIT], propsLabel: "Spotify audio source", props: ['src', 'thumbnail', 'videoProps'] },
                "style": {
                    "display": "flex",
                    width: "100%",
                    objectFit: "cover",
...
export default SpotifyAudioMediaConfig