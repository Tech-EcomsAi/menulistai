        ...
        "children": [
            {
                ...
                "editable": { label: 'Audio', style: [BORDER_RADIUS, BOX_SHADOW, SIZE, OBJECT_FIT], propsLabel: "Audio source", props: ['src', 'thumbnail', 'videoProps'] },
                "style": {
                    "display": "flex",
                    width: "100%",
                    objectFit: "cover",
...
export default AudioMediaConfig