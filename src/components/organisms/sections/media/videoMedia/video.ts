...
const VideoMediaConfig = (UID) => {
    return {
        ...
        "children": [
            {
                "uid": `${UID}${SECTION_UID_SEPARATOR}${getUID()}`,
                "component": COMPONENTS_TYPE.VIDEO,
                "componentName": "Video",
                "props": {
                    autoPlay: true,//Specifies that the video will start playing as soon as it is ready
                    ...
                    // preload:true,
                    "src": "https://player.vimeo.com/progressive_redirect/playback/918754374/rendition/360p/file.mp4"
                },
                "editable": { label: 'Video', style: [BORDER_RADIUS, BOX_SHADOW, SIZE, OBJECT_FIT], propsLabel: "Video source", props: ['src', 'thumbnail', 'videoProps'] },
                "style": {
                    "display": "flex",
                    width: "100%",
                    objectFit: "cover",
...
export default VideoMediaConfig