...
const COLLECTION = `${DB_COLLECTIONS.AI_OPERATIONS}/${AI_OPERATIONS_COLLECTIONS.BACKGROUND_REMOVAL}`;
...
export const addUserBGRTransaction = async (fileDetails: UploadedImageFileDatatype) => {
