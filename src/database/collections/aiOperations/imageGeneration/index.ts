...
const COLLECTION = `${DB_COLLECTIONS.AI_OPERATIONS}/${AI_OPERATIONS_COLLECTIONS.IMAGE_GENERATION}`;
...
export const addUserImageGenerationTransaction = async (fileDetails: UploadedImageFileDatatype) => {
    return await apiCallComposer(
        ...
        fileDetails,
        "addUserImageGenerationTransaction"
    );
}
